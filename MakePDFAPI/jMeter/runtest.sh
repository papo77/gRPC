...
/Applications/apache-jmeter-5.6.3/bin/jmeter -n -t /Volumes/IronHide/dev/NET/grpc/MakePDF/MakePDFAPI/jmeter/MakePDF.jmx -l $results_output_path/results.jtl -e -o $report_output_path